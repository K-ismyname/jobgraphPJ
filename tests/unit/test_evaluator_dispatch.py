...
def test_deploy_url_dispatches_deploy():
    sends = evaluator_dispatch({"resume_skills": [], "github_urls": [],
                                "pdf_path": None, "resume_text": None,
                                "portfolio_path": None, "deploy_urls": ["https://x.com"]})
